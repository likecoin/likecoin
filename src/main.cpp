...
uint256 hashGenesisBlock("0x7ea1042def3975d4366cf3be66029d47c9768e45cc19d576743f56686c71d19b");
...
static const int64 nTargetTimespan = 2 * 60 * 60; // likecoin: 2 hours
static const int64 nTargetSpacing = 60; // likecoin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal likecoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7ea1042def3975d4366cf3be66029d47c9768e45cc19d576743f56686c71d19b");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "02/Jan/2014 Pakistan's former military ruler Pervez Musharraf was rushed to hospital after suffering a 'heart problem' on his way to court.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388682084; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2091761561;

        if (fTestNet)
        {
            block.nTime    = 1388682084;
            block.nNonce   = 2091761561;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x774b9180cff4ec0d5e94c3b745a29654b517e5b1f8c7e3267f4c01e2b36c05c5"));
